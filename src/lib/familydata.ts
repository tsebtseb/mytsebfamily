...
export const daddySpecial: SpecialList[] = [
  {
   ...
   \t ขอให้ทำสิ่งใดก็สมปรารถนานะคะ แต่ไม่ต้องห่วงค่ะ หนูเชื่อในตัวพ่อ พ่อหนูเก่งที่สุดในโลก พ่อหนูคิดดีทำดีอยู่แล้ว
    ...
    \n\n
    \tหนูอาจจะมองโลกในแบบที่จริงจังกับตัวเองตึงกับตัวเองในหลายด้านไปหน่อย ขอโทษนะคะ แต่เดี๋ยวการเติบโตและเวลาก็คงขัดเกลามุมมองหนูไปเรื่อยๆ หวังว่าหนูจะเติบยิ่งขึ้นกว่านี้ให้เป็นที่พึ่งของพ่อและทุกคนได้ ให้พ่อได้ภูมิใจกับการเติบโตของหนู 
    \n\n
