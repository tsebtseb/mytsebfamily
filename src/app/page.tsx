...
import FamilyPic from "/public/bestaiGraduate.png";
...
export default function Home() {
  const [openBestPic, setOpenBestPic] = useState<boolean>(false);
  return (
    <>
        ...
        <section className="bg-warm-pink p-4  w-full md:w-1/2 items-center justify-center lg:flex xl:w-2/5 md:m-2 lg:m-4 md:rounded-3xl lg:rounded-3xl">
          <div className="flex max-h-[800px] max-w-[430px] flex-col justify-center space-y-10">
            ...
            <div className="space-y-5 text-white">
              <h1 className="text-3xl font-bold font-popping">
                From your Best
              </h1>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="grid max-h-[70vh] overflow-y-scroll flex-1 gap-y-4">
                      <p className="indent-8">
                        อันนี้เป็นโปรเจคเล็กๆที่หนูอยากทำขึ้นด้วยความตั้งใจของตัวเอง
                        ให้ตัวเอง ให้ครอบครัว คุณพ่อ,คุณแม่และพี่ธาม
                        เป็นเหมือนการเก็บบันทึกไว้เป็นเมมโมรี่เล็กน้อยน่ารักๆค่ะ
                        เพราะหนูขี้ลืมด้วย
                        ...
                        แต่ก็อยากให้มันแตกต่างออกไปและให้สะดวกกับทุกคนเข้าถึงได้ง่าย
                        และก็อวดความสามารถตัวเองไม่ให้สนิมเกาะด้วยค่ะ 555
                        หวังว่าสิ่งนี้จะสร้างความสุขให้พ่อแม่พี่ธามเอนจอยได้ไม่มากก็น้อยนะคะ
                      </p>
                      <p className="indent-8">
                        เนื่องในโอกาสอายุจะขึ้นเลข24แล้วด้วย
                        อันนี้ก็เหมือนเป็นโปรเจคฉลองการทำงานครั้งแรก
                        หนูอยากแสดงการเติบโต ว่านกที่พ่อกับแม่คอยดูแลวันนั้น
                        จะกางปีกโพบินในแบบของตัวเองให้ได้
                        ขอบคุณที่เลี้ยงดูหนูมาอย่างดี
                        ขอขมาถ้าทำอะไรไม่ดีหรือดื้อไปนะคะ
                        หนูอยากเติบโตให้มากขึ้นและเป็นที่พึ่งของทุกคนได้
                      </p>
                      <p className="indent-8">
                        ไม่ต้องน้อยใจนะคะ ถ้ารูปไหนไม่สวยหรือรูปใครน้อยกว่า
                        หนูเอาจากที่หามาได้และเซฟไว้
                        บางทีอาจจะหาได้ไม่ครบหรือตกหล่นไปบ้าง
                        ถ้ามีอะไรผิดพลาดตรงไหน ขอโทษด้วยนะคะ
                      </p>
                    </div>
                  </div>
      ...
      {openBestPic && (
        <div
          onClick={() => setOpenBestPic(false)}
          className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4"
        >
          <button
            onClick={() => setOpenBestPic(false)}
            className="fixed right-3 top-3 z-[60] flex h-10 w-10 items-center justify-center rounded-full text-3xl text-white backdrop-blur-sm"
          >
            ×
          </button>
